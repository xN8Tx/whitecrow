...
export interface ApiStudentAnswerStudentAnswer extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    answers: Attribute.JSON;
    psychologistReview: Attribute.Text;
    teacherReview: Attribute.Text;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::student-answer.student-answer': ApiStudentAnswerStudentAnswer;
